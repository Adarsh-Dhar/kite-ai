...
class Settings(BaseSettings):
    ...
    kite_rpc_url: str = Field(
        default="https://rpc.kiteai.xyz",
        alias="KITE_RPC_URL",
    )
    kite_market_factory_address: str = Field(
        default="0xMarketFactoryContractAddress",
        alias="KITE_MARKET_FACTORY_ADDRESS",
        description="Smart contract address of the Kite Market Factory.",
    )
    ...
    model_config = {
        ...
        "extra": "ignore"  # This tells Pydantic to skip extra variables in .env
    }