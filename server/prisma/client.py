...
SCHEMA_PATH = Path('/Users/adarsh/Documents/kite-ai/server/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/adarsh/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    deployedpr: 'actions.DeployedPRActions[models.DeployedPR]'
    resolutionlog: 'actions.ResolutionLogActions[models.ResolutionLog]'
    agentcycle: 'actions.AgentCycleActions[models.AgentCycle]'
    securityadvisory: 'actions.SecurityAdvisoryActions[models.SecurityAdvisory]'
    ...
    def __init__(
        ...
        *,
        ...
        self.deployedpr = actions.DeployedPRActions[models.DeployedPR](self, models.DeployedPR)
        self.resolutionlog = actions.ResolutionLogActions[models.ResolutionLog](self, models.ResolutionLog)
        self.agentcycle = actions.AgentCycleActions[models.AgentCycle](self, models.AgentCycle)
        self.securityadvisory = actions.SecurityAdvisoryActions[models.SecurityAdvisory](self, models.SecurityAdvisory)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/adarsh/Documents/kite-ai/server/prisma/schema.prisma',
        }
...
class Batch:
    ...
    deployedpr: 'DeployedPRBatchActions'
    resolutionlog: 'ResolutionLogBatchActions'
    agentcycle: 'AgentCycleBatchActions'
    securityadvisory: 'SecurityAdvisoryBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.deployedpr = DeployedPRBatchActions(self)
        self.resolutionlog = ResolutionLogBatchActions(self)
        self.agentcycle = AgentCycleBatchActions(self)
        self.securityadvisory = SecurityAdvisoryBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ResolutionLogBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class SecurityAdvisoryBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
